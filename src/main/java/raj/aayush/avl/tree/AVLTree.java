package raj.aayush.avl.tree;

import raj.aayush.binary.search.tree.BinarySearchTree;
import raj.aayush.binary.tree.BinaryTree;

/**
 * from java9 data structure
 */
public class AVLTree<E extends Comparable<E>> extends BinarySearchTree<E> {
	public static class Node<E extends Comparable<E>> extends BinaryTree.Node<E> {
	...
	protected void rebalance(Node<E> node) {
		...
		case 2:
			...
			int childRightHeight = nullSafeHeight((Node<E>) node.getLeft().getRight());
